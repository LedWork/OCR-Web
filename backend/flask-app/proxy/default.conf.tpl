    ...
    http {
        ...
        server {
            listen 80;
            listen [::]:80;
            server_name ocr-pck.eu www.ocr-pck.eu;
        ...
        server {
            ...
            ssl_certificate /etc/letsencrypt/live/ocr-pck.eu/fullchain.pem;
            ssl_certificate_key /etc/letsencrypt/live/ocr-pck.eu/privkey.pem;
